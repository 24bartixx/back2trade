...
import { createChart, ISeriesApi, UTCTimestamp, CandlestickSeriesOptions, CandlestickSeries, SeriesMarker, createSeriesMarkers, IChartApi } from 'lightweight-charts';
...
export default function TradingChart({ symbol, interval, fast, slow, onMetricsUpdate }: TradingChartProps) {
  ...
  return (
    <div>
      <div ref={containerRef} style={{ width: '100%', border: '1px solid #eee', borderRadius: 8 }} />
      <button 
        onClick={runBacktest}
        style={{ 
          marginTop: 16, 
